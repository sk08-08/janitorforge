...
import { CustomBlocklist } from "@/components/dashboard/custom-blocklist";
import { GlobalBlocklist } from "@/components/dashboard/global-blocklist";
import { SensitivityLevelSettings } from "@/components/dashboard/sensitivity-level";
...
export function ModerationAdminTab() {
  ...
  const loadAll = useCallback(async () => {
    ...
    setLoading(false);
  }, [loadStats, loadForms, loadFlags, loadBlockedIps]);
      ...
      <Card className="border-border/70 bg-gradient-to-br from-card via-card to-primary/5">
        <CardHeader className="pb-3">
          ...
          <p className="text-sm text-muted-foreground">
            Global moderation queue, form-level safety controls, blocklists, and
            IP firewall tools for admins.
          </p>
        </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              {selectedForm ? (
                ...
                <div className="rounded-lg border border-dashed p-6 text-center text-sm text-muted-foreground">
                  Select a form to manage its moderation and security settings.
                </div>
              )}
            </CardContent>
          </Card>
